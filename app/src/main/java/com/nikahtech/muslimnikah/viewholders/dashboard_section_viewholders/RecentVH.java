...
public class RecentVH extends RecyclerView.ViewHolder{
    ...
    ItemDashRecentBinding binding;

    public RecentVH(ItemDashRecentBinding binding) {
        super(binding.getRoot());
        this.binding = binding;
    }

    public void bind(Recent model, Context context) {
        ...
        binding.viewAllTxt.setOnClickListener(view -> openListAllProfiles(context, "New Profiles"));
